...
<head>
  ...
  <meta name="description" content="BackTrack Linux was 2006-2013. Now reborn as Kali Linux">

  <title>EDIT-Educational information tools in thailand</title>
...
body {
  ...
  background-image:url(images/110411-black-blurred-background-vector.jpg);
  ...
  <script type="application/ld+json" async>
{
  ...
  "url": "https://www.backtrack-linux.org/",
  "logo": "https://www.backtrack-linux.org/images/backtrack-black.png"
}
  </script>
...
<div class="centered">
  <a href="https://www.edit.in.th">
    Information technology tools for educational in thailand.
  </a>
  ...
  <center>
    <h1>
      <a class="button" href="https://www.edit.in.th/main/">
        Educational information tools in Thailand
      </a>
    </h1>
  </center>
...
<div class="entries">
  <div class="entry">
    <div class="title">November 23th 2021</div>
    <div class="body">
      <p>Register edit.in.th Domain</p>
    </div><!-- end body -->
  </div><!-- end entry -->
</div><!-- end entries -->
...
<div id="footer">
  ...
  <h2 style="display:none;">Visit some of our other projects</h2>

  <div class="grid">
    <div class="col-quarter">
      <a href="https://www.edsup.org/" title="" target="_blank" rel="">
        EDSup.org
      </a>
    </div><!-- end col-quarter -->
    <div class="col-quarter">
    ...
    <div class="col-quarter">
      <a href="ed30.edsup.org" title="" target="_blank" rel="">
        ED.inded 30th
      </a>
    </div><!-- end col-quarter -->
    <div class="col-quarter">
  ...
  <script>function footerDate(){ var getYear=(new Date().getFullYear()); document.getElementById("footerYear").innerHTML = getYear;}footerDate();</script>
</div><!-- end footer -->
